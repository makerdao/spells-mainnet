...
contract Config {
    ...
    function setValues(address chief) public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:         address(0x7B55617f7F04F7B45eE865fF9066469Fbe28a632), // populate with deployed spell if deployed
            deployed_spell_created: 1716989783,          // use `make deploy-info tx=<deployment-tx>` to obtain the timestamp
            deployed_spell_block:   19975854,          // use `make deploy-info tx=<deployment-tx>` to obtain the block number
