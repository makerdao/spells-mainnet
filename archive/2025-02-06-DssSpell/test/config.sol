...
contract Config {
    ...
    function setValues() public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:         address(0x1695fa1674eFf5DAa1C579246038cc81bE26Ffa7), // populate with deployed spell if deployed
            deployed_spell_created: 1738853375,          // use `make deploy-info tx=<deployment-tx>` to obtain the timestamp
            deployed_spell_block:   21788166,          // use `make deploy-info tx=<deployment-tx>` to obtain the block number
