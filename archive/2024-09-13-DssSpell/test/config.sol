...
contract Config {
    ...
    function setValues(address chief) public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:         address(0x70254BD530684CF4a6323F51098FA39AAE6130b6), // populate with deployed spell if deployed
            deployed_spell_created: 1726224359,          // use `make deploy-info tx=<deployment-tx>` to obtain the timestamp
            deployed_spell_block:   20741186,          // use `make deploy-info tx=<deployment-tx>` to obtain the block number
