...
contract Config {
    ...
    function setValues() public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:         address(0xc5a09c1DA06BEadA9bE92F5fEF4Da3aF0E22dA5a), // populate with deployed spell if deployed
            deployed_spell_created: 1733834027, // use `make deploy-info tx=<deployment-tx>` to obtain the timestamp
            deployed_spell_block:   21372130,   // use `make deploy-info tx=<deployment-tx>` to obtain the block number
        ...
        afterSpell.pot_dsr                = 14_50;                          // In basis points
        afterSpell.susds_ssr              = 15_50;                          // In basis points
