...
contract Config {
    ...
    function setValues(address chief) public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:                 address(0xB945b792A1a87308C11573e7E9739f792dBCe226),        // populate with deployed spell if deployed
            deployed_spell_created:         1661950301,        // use get-created-timestamp.sh if deployed
