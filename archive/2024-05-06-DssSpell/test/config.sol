...
contract Config {
    ...
    function setValues(address chief) public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:         address(0x6cd68b55cdc991938D95D6995d97eB807AAEAE44), // populate with deployed spell if deployed
            deployed_spell_created: 1715002295,          // use `make deploy-info tx=<deployment-tx>` to obtain the timestamp
            deployed_spell_block:   19811357,          // use `make deploy-info tx=<deployment-tx>` to obtain the block number
