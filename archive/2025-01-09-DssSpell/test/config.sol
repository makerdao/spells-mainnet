...
contract Config {
    ...
    function setValues() public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:         address(0x5985E06E47e0dd10230393e5dEF7200516262ed9), // populate with deployed spell if deployed
            deployed_spell_created: 1736442371, // use `make deploy-info tx=<deployment-tx>` to obtain the timestamp
            deployed_spell_block:   21588299,   // use `make deploy-info tx=<deployment-tx>` to obtain the block number
