...
contract Config {
    ...
    function setValues(address chief) public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:                 address(0xD8E6fBb43354dd6637561208eF5Db1a62e6408DC),        // populate with deployed spell if deployed
            deployed_spell_created:         1651237244,        // use get-created-timestamp.sh if deployed
