...
contract Config {
    ...
    function setValues(address chief) public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:                 address(0x3ea2748a32D53449bee93e2AE101E6d7179d7865),        // populate with deployed spell if deployed
            deployed_spell_created:         1664361407,        // use get-created-timestamp.sh if deployed
