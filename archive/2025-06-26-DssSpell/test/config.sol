...
contract Config {
    ...
    function setValues() public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:         address(0xC9c4ddF824e4fF80158aB7862D168a35ce616e8E), // populate with deployed spell if deployed
            deployed_spell_created: 1750953023, // use `make deploy-info tx=<deployment-tx>` to obtain the timestamp
            deployed_spell_block:   22789620,   // use `make deploy-info tx=<deployment-tx>` to obtain the block number
