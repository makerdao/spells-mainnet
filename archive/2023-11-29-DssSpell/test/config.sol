...
contract Config {
    ...
    function setValues(address chief) public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:         address(0x4F09EbaA1A5e52EB95c97f3b9fa3fb398D004698), // populate with deployed spell if deployed
            deployed_spell_created: 1701266963,          // use `make deploy-info tx=<deployment-tx>` to obtain the timestamp
            deployed_spell_block:   18677774,          // use `make deploy-info tx=<deployment-tx>` to obtain the block number
