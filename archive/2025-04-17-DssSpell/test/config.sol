...
contract Config {
    ...
    function setValues() public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:         address(0xe4710c979485ecF2cBAD7C7C2a7Bc28c5c521749), // populate with deployed spell if deployed
            deployed_spell_created: 1744901243, // use `make deploy-info tx=<deployment-tx>` to obtain the timestamp
            deployed_spell_block:   22289407,   // use `make deploy-info tx=<deployment-tx>` to obtain the block number
