...
contract Config {
    ...
    function setValues(address chief) public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:                 address(0xEEC1e1aef39309998d14615a177d989F37342cf1),        // populate with deployed spell if deployed
            deployed_spell_created:         1647009441,        // use get-created-timestamp.sh if deployed
