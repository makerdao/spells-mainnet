...
contract Config {
    ...
    function setValues() public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:         0x3f6e730C77496aAB65655b3A5BDF6242C6eee4Cc, // populate with deployed spell if deployed
            deployed_spell_created: 1730395583,          // use `make deploy-info tx=<deployment-tx>` to obtain the timestamp
            deployed_spell_block:   21087106,          // use `make deploy-info tx=<deployment-tx>` to obtain the block number
