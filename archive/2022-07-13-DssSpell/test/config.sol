...
contract Config {
    ...
    function setValues(address chief) public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:                 address(0xa2e8A5045494C5037b929c1800b99C9C9Fd915E0),        // populate with deployed spell if deployed
            deployed_spell_created:         1657632210,        // use get-created-timestamp.sh if deployed
