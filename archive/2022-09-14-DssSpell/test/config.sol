...
contract Config {
    ...
    function setValues(address chief) public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:                 address(0xdA607F191B2D9a76Bc7648a1a62B43bb721668e2),        // populate with deployed spell if deployed
            deployed_spell_created:         1663172422,                 // use get-created-timestamp.sh if deployed
