...
contract Config {
    ...
    function setValues(address chief) public {
        ...
        prevSpells[0] = address(0xa1c423ee0bbC927EF5809c7ebB24c86D4284e431);

        //
        // Values for spell-specific parameters
        //
        spellValues = SpellValues({
            deployed_spell:                 address(0xB70254F2C2C342fB3B168cDa1E43db1E43Ab8DE1),         // populate with deployed spell if deployed
            deployed_spell_created:         1685007227,                  // use `make deploy-info tx=<deployment-tx>` to obtain the timestamp
            deployed_spell_block:           17335301,                  // use `make deploy-info tx=<deployment-tx>` to obtain the block number
        ...
        afterSpell.chainlog_version =      "1.14.12";               // String expected in system
