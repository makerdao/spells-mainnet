...
contract Config {
    ...
    function setValues(address chief) public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:                 address(0x6febea3673AdF3925A01a61E46924B5b67A69Ec3),        // populate with deployed spell if deployed
            deployed_spell_created:         1652808247,                 // use get-created-timestamp.sh if deployed
