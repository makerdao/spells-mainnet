...
contract Config {
    ...
    function setValues(address chief) public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:                 address(0xf9a88bBABBe4b5b907D28322649c504cA9897892),         // populate with deployed spell if deployed
            deployed_spell_created:         1693393043,                  // use `make deploy-info tx=<deployment-tx>` to obtain the timestamp
            deployed_spell_block:           18026969,                  // use `make deploy-info tx=<deployment-tx>` to obtain the block number
