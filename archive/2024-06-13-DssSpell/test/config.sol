...
contract Config {
    ...
    function setValues(address chief) public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:         address(0x622Ad624491a01a2a6beAD916C3Ca3B90BcA0854), // populate with deployed spell if deployed
            deployed_spell_created: 1718197007,          // use `make deploy-info tx=<deployment-tx>` to obtain the timestamp
            deployed_spell_block:   20075890,          // use `make deploy-info tx=<deployment-tx>` to obtain the block number
