...
contract Config {
    ...
    function setValues(address chief) public {
        ...
        prevSpells[0] = 0xd896928bd173a370fA1Db446462A19b09Bd95BF0;

        //
        // Values for spell-specific parameters
        //
        spellValues = SpellValues({
            deployed_spell:                 address(0x77107F74bf30250aFFada0fbD09fa517658B4916),         // populate with deployed spell if deployed
            deployed_spell_created:         1683029711,         // use `make deploy-info tx=<deployment-tx>` to obtain the timestamp
            deployed_spell_block:           17173025,           // use `make deploy-info tx=<deployment-tx>` to obtain the block number
        ...
        afterSpell.ilk_count =             62;                      // Num expected in system
        afterSpell.chainlog_version =      "1.14.11";               // String expected in system
