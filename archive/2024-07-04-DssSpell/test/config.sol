...
contract Config {
    ...
    function setValues(address chief) public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:         address(0x0c0B4DA7e02960F98c2AFf2778F6f3E37321B5Dd), // populate with deployed spell if deployed
            deployed_spell_created: 1720109891, // use `make deploy-info tx=<deployment-tx>` to obtain the timestamp
            deployed_spell_block:   20234291,   // use `make deploy-info tx=<deployment-tx>` to obtain the block number
