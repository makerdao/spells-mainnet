...
contract Config {
    ...
    function setValues(address chief) public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:                 address(0x76b686379234C90b2d9d4A9412A359783273f6b2),        // populate with deployed spell if deployed
            deployed_spell_created:         1655315169,        // use get-created-timestamp.sh if deployed
