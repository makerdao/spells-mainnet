...
contract Config {
    ...
    function setValues(address chief) public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:         address(0x6e17A15427eD7A411e7d55e53C13c8cE655c35C9), // populate with deployed spell if deployed
            deployed_spell_created: 1727355491,          // use `make deploy-info tx=<deployment-tx>` to obtain the timestamp
            deployed_spell_block:   20834938,          // use `make deploy-info tx=<deployment-tx>` to obtain the block number
