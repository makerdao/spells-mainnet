...
contract Config {
    ...
    function setValues(address chief) public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:                 address(0xfDb8135Dd29785dA7486a96974D3b6a687430821),        // populate with deployed spell if deployed
            deployed_spell_created:         1652174349,                 // use get-created-timestamp.sh if deployed
