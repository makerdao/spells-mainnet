...
contract Config {
    ...
    function setValues(address chief) public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:                 address(0x6f076E9eB81828fa83d9c3E0aa3E088AD24Ee20B),        // populate with deployed spell if deployed
            deployed_spell_created:         1653413447,                 // use get-created-timestamp.sh if deployed
