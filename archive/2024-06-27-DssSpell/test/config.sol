...
contract Config {
    ...
    function setValues(address chief) public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:         address(0x7fbC867dE58D6e47E430eB257B50481F6E878f65), // populate with deployed spell if deployed
            deployed_spell_created: 1719418967, // use `make deploy-info tx=<deployment-tx>` to obtain the timestamp
            deployed_spell_block:   20177030,   // use `make deploy-info tx=<deployment-tx>` to obtain the block number
