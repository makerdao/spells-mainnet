...
contract Config {
    ...
    function setValues(address chief) public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:                 address(0x07bFA4db5587A75617aFA9E43624b8C2609497b5),        // populate with deployed spell if deployed
            deployed_spell_created:         1662537477,        // use get-created-timestamp.sh if deployed
