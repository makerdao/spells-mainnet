...
contract Config {
    ...
    function setValues() public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:         address(0x12a79fAcd8D6Bbb1583593ef414897A9bA8f0D26), // populate with deployed spell if deployed
            deployed_spell_created: 1753365743, // use `make deploy-info tx=<deployment-tx>` to obtain the timestamp
            deployed_spell_block:   22989480,   // use `make deploy-info tx=<deployment-tx>` to obtain the block number
