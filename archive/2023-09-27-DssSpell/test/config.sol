...
contract Config {
    ...
    function setValues(address chief) public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:         address(0xD3F96B8Ffbf21033F5A6210C6349598AAdBd1152), // populate with deployed spell if deployed
            deployed_spell_created: 1695928199,          // use `make deploy-info tx=<deployment-tx>` to obtain the timestamp
            deployed_spell_block:   18236225,          // use `make deploy-info tx=<deployment-tx>` to obtain the block number
