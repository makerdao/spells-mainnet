...
contract Config {
    ...
    function setValues(address chief) public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:                 address(0x23Ed2d46c47c5f99684346374F3Ed5AC29561737),        // populate with deployed spell if deployed
            deployed_spell_created:         1649425484,        // use get-created-timestamp.sh if deployed
