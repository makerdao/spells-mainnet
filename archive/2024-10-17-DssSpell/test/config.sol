...
contract Config {
    ...
    function setValues() public {
        ...
        spellValues = SpellValues({
            ...
            deployed_spell_created: 1729197815,          // use `make deploy-info tx=<deployment-tx>` to obtain the timestamp
            deployed_spell_block:   20987749,          // use `make deploy-info tx=<deployment-tx>` to obtain the block number
