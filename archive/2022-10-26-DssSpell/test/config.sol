...
contract Config {
    ...
    function setValues(address chief) public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:                 address(0xd4e3C9D45C15881DB96A940DDE8E6Ab50296B43E),   // populate with deployed spell if deployed
            deployed_spell_created:         1666806947,        // use `./scripts/get-created-timestamp.sh <deployment-tx>`
