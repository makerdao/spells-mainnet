...
contract Config {
    ...
    function setValues(address chief) public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:                 address(0x4124b7a881DBBF98D72474D1A882d3afE3758526),   // populate with deployed spell if deployed
            deployed_spell_created:         1666807691,        // use `./scripts/get-created-timestamp.sh <deployment-tx>`
