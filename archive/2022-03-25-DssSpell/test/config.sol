...
contract Config {
    ...
    function setValues(address chief) public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:                 address(0x63b730eF5364DF9f006E86B156AC97CDEf044780),        // populate with deployed spell if deployed
            deployed_spell_created:         1648223126,                 // use get-created-timestamp.sh if deployed
