...
contract Config {
    ...
    function setValues(address chief) public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:         address(0x65eEEfa08204b9717502398Abf37C52D91fb6693), // populate with deployed spell if deployed
            deployed_spell_created: 1713795479,          // use `make deploy-info tx=<deployment-tx>` to obtain the timestamp
            deployed_spell_block:   19711484,          // use `make deploy-info tx=<deployment-tx>` to obtain the block number
