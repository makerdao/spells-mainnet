...
contract Config {
    ...
    function setValues(address chief) public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:         address(0xb242159a9182e7FE0b72Fc035b336cFE060381B3), // populate with deployed spell if deployed
            deployed_spell_created: 1697238827,          // use `make deploy-info tx=<deployment-tx>` to obtain the timestamp
            deployed_spell_block:   18344675,          // use `make deploy-info tx=<deployment-tx>` to obtain the block number
