...
contract Config {
    ...
    function setValues(address chief) public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:                 address(0xf34fFe4191c02608f0262172C9C45f48Fd3C3D92),         // populate with deployed spell if deployed
            deployed_spell_created:         1679671091,                  // use `make deploy-info tx=<deployment-tx>` to obtain the timestamp
            deployed_spell_block:           16898201,                  // use `make deploy-info tx=<deployment-tx>` to obtain the block number
