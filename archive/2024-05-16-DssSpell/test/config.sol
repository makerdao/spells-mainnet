...
contract Config {
    ...
    function setValues(address chief) public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:         address(0xB394eC56AbD78c9264438168F8a8E1Bd85F1f0Ae), // populate with deployed spell if deployed
            deployed_spell_created: 1715867207,          // use `make deploy-info tx=<deployment-tx>` to obtain the timestamp
            deployed_spell_block:   19882927,          // use `make deploy-info tx=<deployment-tx>` to obtain the block number
