...
contract DssSpellTest is DSTest, DSMath {
    ...
    function setUp() public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:                 address(0xc5Ed356eadd9863eF78F74155fa4bEE1fc4ad879),        // populate with deployed spell if deployed
            deployed_spell_created:         1620401989,        // use get-created-timestamp.sh if deployed
            previous_spell:                 address(0x3Baab03C225eB9033FC6B73C16D310D56Afa922F),        // supply if there is a need to test prior to its cast() function being called on-chain.
