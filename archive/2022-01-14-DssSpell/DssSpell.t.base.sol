...
contract DssSpellTestBase is Config, DSTest, DSMath {
    ...
    function setUp() public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:                 address(0xDD5052bfC4D281793653B0037d46Cc2d8d1FD1b5),        // populate with deployed spell if deployed
            deployed_spell_created:         1642190897,        // use get-created-timestamp.sh if deployed
