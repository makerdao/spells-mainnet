...
contract Config {
    ...
    function setValues(address chief) public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:                 address(0x24910113D7378cb8BdCbeaC4596Ec68EfccD684d),        // populate with deployed spell if deployed
            deployed_spell_created:         1646410523,        // use get-created-timestamp.sh if deployed
