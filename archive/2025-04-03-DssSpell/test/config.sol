...
contract Config {
    ...
    function setValues() public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:         address(0x6D89a389C59113a9DA17f094c9b8772A97854593), // populate with deployed spell if deployed
            deployed_spell_created: 1743690887,          // use `make deploy-info tx=<deployment-tx>` to obtain the timestamp
            deployed_spell_block:   22189012,          // use `make deploy-info tx=<deployment-tx>` to obtain the block number
        ...
        afterSpell.chainlog_version       = "1.19.8";                       // String expected in system
