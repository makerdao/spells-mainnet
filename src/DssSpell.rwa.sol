...
contract DssSpellAction is DssAction {
    ...
    function actions() public override {
        ...
        // -------------------------------- RWA002 --------------------------------
        bytes32 RWA002_ilk   = "RWA002-A";
        uint256 RWA002_CEIL_old  = 5 * MILLION;
        uint256 RWA002_CEIL  = 20 * MILLION;

        // Increase the global debt ceiling by the ilk ceiling
        DssExecLib.increaseGlobalDebtCeiling(RWA002_CEIL - RWA002_CEIL_old);
        // Set the ilk debt ceiling
        DssExecLib.setIlkDebtCeiling(RWA002_ilk, RWA002_CEIL);
        ...
        // stability fee
        DssExecLib.setIlkStabilityFee(RWA003_ilk, SEVEN_PCT, false);
        ...
        DssExecLib.setChangelogAddress("PIP_RWA003", RWA003_pip);
