...
import {DssSpell, SpellAction} from "./2020-07-03-DssSpell.sol";
...
contract DssSpellTest is DSTest, DSMath {
    ...
    address constant MAINNET_SPELL = address(0x057d35a858D6350D10F714785bAf5C07703DbD4C);
    uint256 constant SPELL_CREATED = 1593793249;
    ...
    function setUp() public {
        ...
        beforeSpell.collaterals["ETH-A"] = CollateralValues({
            ...
            dust: 20 * RAD,
            duty: 1000000000079175551708715274,
            pct: 0.25 * 1000,
            chop: 113 * RAY / 100,
            lump: 500 * WAD,
            mat: 150 * RAY / 100,
        ...
        beforeSpell.collaterals["WBTC-A"] = CollateralValues({
            line: 10 * MILLION * RAD,
            dust: 20 * RAD,
            duty: 1000000000393915525145987602,
            pct: 1.25 * 1000,
            chop: 113 * RAY / 100,
            lump: 1 * WAD,
            mat: 150 * RAY / 100,
