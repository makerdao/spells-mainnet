...
import {DssSpell, SpellAction} from "./2020-07-31-DssSpell.sol";
...
contract DssSpellTest is DSTest, DSMath {
    ...
    address constant MAINNET_SPELL = address(0xf132619F3AA8Fc35b256C089097E91A0C2b3902a);
    uint256 constant SPELL_CREATED = 1596210140;
    ...
    address               dYdX =                 0x538038E526517680735568f9C5342c6E68bbDA12;
    ...
    function setUp() public {
        ...
        afterSpell.collaterals["USDC-A"].duty = 1000000000000000000000000000;
        afterSpell.collaterals["USDC-A"].pct = 0;

        // USDC-B
        afterSpell.collaterals["USDC-B"] = beforeSpell.collaterals["USDC-B"];
        afterSpell.collaterals["USDC-B"].duty = 1000000012000140727767957524;
        afterSpell.collaterals["USDC-B"].pct = 46 * 1000;
        ...
        afterSpell.collaterals["WBTC-A"].pct = 0;

        // KNC-A
        afterSpell.collaterals["KNC-A"]  = beforeSpell.collaterals["KNC-A"];
        afterSpell.collaterals["KNC-A"].duty = 1000000000000000000000000000;
        afterSpell.collaterals["KNC-A"].pct = 0;

        // ZRX-A
        afterSpell.collaterals["ZRX-A"]  = beforeSpell.collaterals["ZRX-A"];
        afterSpell.collaterals["ZRX-A"].duty = 1000000000000000000000000000;
        afterSpell.collaterals["ZRX-A"].pct = 0;

        // MANA-A
        afterSpell.collaterals["MANA-A"] = beforeSpell.collaterals["MANA-A"];
        afterSpell.collaterals["MANA-A"].duty = 1000000002440418608258400030;
        afterSpell.collaterals["MANA-A"].pct = 8 * 1000;
