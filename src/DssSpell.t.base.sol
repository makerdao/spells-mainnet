...
contract DssSpellTestBase is Config, DSTest, DSMath {
    ...
    function setUp() public {
        ...
        spellValues = SpellValues({
            ...
            deployed_spell_created:         1643058826,        // use get-created-timestamp.sh if deployed
            previous_spell:                 address(0x0f5D4cF379902655F2f4Cd1B594cd61818892cc1),        // supply if there is a need to test prior to its cast() function being called on-chain.
