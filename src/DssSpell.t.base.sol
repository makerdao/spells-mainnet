...
contract DssSpellTestBase is Config, DSTest, DSMath {
    ...
    function setUp() public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:                 address(0x3142dafd5aD998E35EB8E4Bc8E7D01545E02281A),        // populate with deployed spell if deployed
            deployed_spell_created:         1643391294,        // use get-created-timestamp.sh if deployed
