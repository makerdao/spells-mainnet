...
contract DssSpellTestBase is DSTest, DSMath {
    ...
    function setUp() public {
        ...
        spellValues = SpellValues({
            ...
            deployed_spell_created:         1638820816,        // use get-created-timestamp.sh if deployed
            previous_spell:                 address(0x3a686Cd0c748E95524ed6532A64CE5Fe4A301CA7),        // supply if there is a need to test prior to its cast() function being called on-chain.
