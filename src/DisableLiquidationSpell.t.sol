...
import {DisableLiquidationSpell} from "./DisableLiquidationSpell.sol";
...
contract DisableLiquidationSpellTest is DSTest, DSMath {
    ...
    function setUp() public {
        ...
        spell = MAINNET_SPELL != address(0) ? DisableLiquidationSpell(MAINNET_SPELL) : new DisableLiquidationSpell();
    }
