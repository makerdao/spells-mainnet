...
contract Config {
    ...
    function setValues() public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:         address(0x2A0851A1eaf13b4816fd11B11b2e0060611932F4), // populate with deployed spell if deployed
            deployed_spell_created: 1742473127, // use `make deploy-info tx=<deployment-tx>` to obtain the timestamp
            deployed_spell_block:   22088026,   // use `make deploy-info tx=<deployment-tx>` to obtain the block number
