...
contract Config {
    ...
    function setValues(address chief) public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:                 address(0x0900328701eA2561F530869c4fe088A72256409C),        // populate with deployed spell if deployed
            deployed_spell_created:         1664983715,        // use get-created-timestamp.sh if deployed
