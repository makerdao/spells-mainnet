...
contract Config {
    ...
    function setValues() public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:         0xa3Ac72a48F50785523FeE514E79C274303230823, // populate with deployed spell if deployed
            deployed_spell_created: 1730381771,          // use `make deploy-info tx=<deployment-tx>` to obtain the timestamp
            deployed_spell_block:   21085957,          // use `make deploy-info tx=<deployment-tx>` to obtain the block number
