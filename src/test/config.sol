...
contract Config {
    ...
    function setValues(address chief) public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:         address(0x77cF3f27bF48ecD21CFe7293a31272f0aD44bfc6), // populate with deployed spell if deployed
            deployed_spell_created: 1700149271,          // use `make deploy-info tx=<deployment-tx>` to obtain the timestamp
            deployed_spell_block:   18585407,          // use `make deploy-info tx=<deployment-tx>` to obtain the block number
