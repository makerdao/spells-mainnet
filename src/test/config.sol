...
contract Config {
    ...
    function setValues(address chief) public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:         address(0xc25A71BDF956229a035e35e8038d3FeE4aBa101C), // populate with deployed spell if deployed
            deployed_spell_created: 1723556003,          // use `make deploy-info tx=<deployment-tx>` to obtain the timestamp
            deployed_spell_block:   20520027,          // use `make deploy-info tx=<deployment-tx>` to obtain the block number
