...
contract Config {
    ...
    function setValues(address chief) public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:                 address(0x07D8D43916bc235B71d9683111De7c7c626Bb906),         // populate with deployed spell if deployed
            deployed_spell_created:         1687963187,                  // use `make deploy-info tx=<deployment-tx>` to obtain the timestamp
            deployed_spell_block:           17578470,                  // use `make deploy-info tx=<deployment-tx>` to obtain the block number
