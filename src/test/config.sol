...
contract Config {
    ...
    function setValues(address chief) public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:                 address(0x04D0E226675cfC2450D523C961c1F1875f20bf47),         // populate with deployed spell if deployed
            deployed_spell_created:         1667323871,                  // use `./scripts/get-created-timestamp.sh <deployment-tx>`
        ...
        afterSpell = SystemValues({
            ...
            pause_delay:           48 hours,                // In seconds (60 seconds on Goerli, 48 hours on Mainnet)
