...
contract Config {
    ...
    function setValues(address chief) public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:                 address(0x7925c14B2E533B9CFD3662d6C87441D35820D3f9),         // populate with deployed spell if deployed
            deployed_spell_created:         1680127931,         // use `make deploy-info tx=<deployment-tx>` to obtain the timestamp
            deployed_spell_block:           16935825,           // use `make deploy-info tx=<deployment-tx>` to obtain the block number
