...
contract Config {
    ...
    function setValues(address chief) public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:                 address(0x068F8fb8318506bFbaD57B494A0c7b31399f4Ed6),        // populate with deployed spell if deployed
            deployed_spell_created:         1646842499,        // use get-created-timestamp.sh if deployed
