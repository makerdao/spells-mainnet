...
contract Config {
    ...
    function setValues(address chief) public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:         address(0x4242347798bD2DEc6540dF55E5e47802d9b78aC7), // populate with deployed spell if deployed
            deployed_spell_created: 1706110187, // use `make deploy-info tx=<deployment-tx>` to obtain the timestamp
            deployed_spell_block:   19077396,  // use `make deploy-info tx=<deployment-tx>` to obtain the block number
