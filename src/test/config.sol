...
contract Config {
    ...
    function setValues(address chief) public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:                 address(0xD67A415a55A11C128a04fEd4B9C94cF61A633e7f),        // populate with deployed spell if deployed
            deployed_spell_created:         1656504694,        // use get-created-timestamp.sh if deployed
