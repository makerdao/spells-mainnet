...
contract Config {
    ...
    function setValues(address chief) public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:                 address(0xDF4F93454CbfC864A8f045Bd22566824360042B7),         // populate with deployed spell if deployed
            deployed_spell_created:         1680644507,         // use `make deploy-info tx=<deployment-tx>` to obtain the timestamp
            deployed_spell_block:           16978232,           // use `make deploy-info tx=<deployment-tx>` to obtain the block number
