...
contract Config {
    ...
    function setValues(address chief) public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:                 address(0xdfFa28aAABF9E6a07e19FDf3a9B94fDC93A039f1),        // populate with deployed spell if deployed
            deployed_spell_created:         1665693899,        // use get-created-timestamp.sh if deployed
