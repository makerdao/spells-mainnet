...
contract Config {
    ...
    function setValues() public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:         address(0x8f7Ee1E1204e69C9EbBfEaA17ab7b29E67A9D117), // populate with deployed spell if deployed
            deployed_spell_created: 1733919059, // use `make deploy-info tx=<deployment-tx>` to obtain the timestamp
            deployed_spell_block:   21379176,   // use `make deploy-info tx=<deployment-tx>` to obtain the block number
        ...
        afterSpell.pot_dsr                = 17_50;                          // In basis points
        afterSpell.susds_ssr              = 18_50;                          // In basis points
